...
def processar_csv_banco(file_stream):
    ...
    keywords = {
        ...
        "Restaurantes": [
            "MCDONALDS", "H3", "BURGER", "RESTAURANTE", "BK21548-CALDAS", "BK21548", "BK28948- NAZARE" , "BK28948-",
            "CAFE", "UBER EATS", "GLOVO", "CENTRAL FOZ", "PADARIA", "PASTELARIA", "PIZZA", "SUSHI", "KFC",
            "CHAPELEIRO MALUCO", "100 MONTADITOS", "MARCIANUS", "CHURRASQUEIRA", "TROPICANA NADDOURO", "TROPICANA"
        ],
        "Transporte": [
            "GALP", "BP", "PRIO", "REPSOL", "COMBOIOS", "CP ", "UBER", "BOLT", "EST SERVICO",
            "VIAVERDE", "VIA VERDE", "BRISA", "PARQUE", "MONTEPIO CREDI", "ELECLERC CALDAS DA RAINHACALDAS DA"
